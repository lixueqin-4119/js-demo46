...
var c = {
  ...
  add1: function add1() {
    ...
    m.update({
      n: m.data.n + 1
    }); //更新时触发update,因为只有update才会触发这个事件
  },
  ...
  autoBindEvents: function autoBindEvents() {
    for (var key in c.events) {
      var value = c[c.events[key]]; //c.events[key]取的是字符串，我要取的是方法

      var spaceIndex = key.indexOf(' ');
      var part1 = key.slice(0, spaceIndex + 1);
      var part2 = key.slice(spaceIndex); //console.log(part1, part2, value)
...
var $tabBar = (0, _jquery.default)('#app2 .tab-bar'); //避免冲突
...
$tabBar.on('click', 'li', function (e) {
  //事件委托
  var $li = (0, _jquery.default)(e.currentTarget); //DOM元素用jquery封装下，DOM元素太难用。
